...
instruccion
        ...
        | VOID IDENTIFICADOR PARENTESISABRE listaParametros PARENTESISCIERRA LLAVEABRE instrucciones LLAVECIERRA             { $$ = instrucciones.nuevoMetodoConParametros($2, $4, $7, @1.first_line, @1.first_column) }
        ...
        | CALL IDENTIFICADOR PARENTESISABRE listaOperacionNumerica PARENTESISCIERRA PUNTOCOMA                                       { $$ = instrucciones.nuevoCallMetodoConParametros($2, $4, @1.first_line, @1.first_column) }
...
listaParametros
        ...
        | parametro                                                               { $$ = instrucciones.nuevoListaParametros($1)}
;

parametro
        : tipo_dato IDENTIFICADOR                                                 { $$ = instrucciones.nuevoParametro($1, $2, @1.first_line, @1.first_column)}
;
